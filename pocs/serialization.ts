...
byteSizeTable.push({
  'Method': 'v8 serialize',
  'Byte Length': resultV8.byteLength,
  'Supports Circular References': true,
  'Supports Dates': true,
  'Supports Bigint': true,
});
byteSizeTable.push({
  'Method': 'v8 serialize without circle',
  'Byte Length': resultV8ItWithoutCircle.byteLength,
  'Supports Circular References': true,
  'Supports Dates': true,
  'Supports Bigint': true,
});
byteSizeTable.push({
  'Method': 'Vanilla Stringify',
  'Byte Length': Buffer.from(resultVanillaStringify).byteLength,
  'Supports Circular References': false,
  'Supports Dates': false,
  'Supports Bigint': false,
});
...
byteSizeTable.push({
  'Method': 'Buffer From Fast Stringpfy',
  'Byte Length': serializedFastString.byteLength,
  'Supports Circular References': false,
  'Supports Dates': false,
  'Supports Bigint': false,
});
...
byteSizeTable.push({
  'Method': 'BSON',
  'Byte Length': resBson.byteLength,
  'Supports Circular References': false,
  'Supports Dates': true,
  'Supports Bigint': true,
});
