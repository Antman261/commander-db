...
export const journalReader = new (class JournalReader extends LifecycleComponent {
  ...
  async #readPage() {
    ...
    const children: readonly JournalConsumer<unknown>[] = this.getChildren() as readonly JournalConsumer<
      unknown
    >[];
...
const readEntry = (entry: JnlEntry, pageNo: number) => (component: JournalConsumer<unknown>) =>
