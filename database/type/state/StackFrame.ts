...
/**
 * The identity of a stack frame expressed as a list of frame indexes, where the rightmost value is the FrameIndex of the current stack in the parent, the next rightmost value is the FrameIndex of the parent within its parent, etc. Ultimately, it gives us a path through the tree to the current frame.
 */
